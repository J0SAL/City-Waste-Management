...
router.get("/user/view_complaint/delete/:id", complainController.deleteComplain);
router.get("/authority/view_complaint/:status/:id", complainController.updateComplain);
